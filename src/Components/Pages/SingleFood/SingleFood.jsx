...
const SingleFood = () => {
    ...
    return (
        <section className="bg-gray-100 py-8 md:py-14">
            <Helmet>
                <title>Surplus Sustain || Food Details</title>
            </Helmet>
            ...
            <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row bg-white">
                ...
                <div className="pb-4 lg:p-10 px-2 md:px-12  mt-4 lg:mt-0">
                    <h1 className="text-center lg:text-start text-2xl md:text-4xl text-Primary font-bold">
                        Food: {name}
                    </h1>
                    <h2 className="text-center lg:text-start text-lg md:text-xl mt-2 text-Secondary font-semibold">
                        Note: {notes}
                    </h2>
                    ...
                    <div className="">
                        <h2 className="text-lg text-Secondary font-semibold mb-1">
                            Donor Info:
                        </h2>
                            ...
                            <form action="" onSubmit={handleRequestForm}>
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        id="input-gray"
                                        type="text"
                                        placeholder="Enter a note shortly"
                                        required
                                        color="gray"
                                    />
                                </div>
