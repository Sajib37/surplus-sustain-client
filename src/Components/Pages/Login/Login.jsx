...
const Login = () => {
    return (
        <div className="bg-gray-200 md:bg-gray-100 py-8 md:py-12 px-1">
            <section className="max-w-md  mx-auto px-1 md:px-4  md:max-w-lg lg:max-w-lg bg-white rounded-lg py-10 md:py-12">
