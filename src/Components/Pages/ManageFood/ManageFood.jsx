...
const ManageFood = () => {
    ...
    return (
        <section className=" bg-gray-100 py-8 md:py-12 ">
            <Helmet>
                <title>Surplus Sustain || Manage My Food</title>
            </Helmet>
                ...
                <div>
                    <section className="max-w-screen-xl mx-auto px-2 py-4 bg-white mb-6 md:mb-12">
                        {myFood.length === 0 ? (
                            <h1 className="text-xl md:text-3xl text-center text-Primary font-bold">
                                Explore the table below to see your added foods.
                            </h1>
                        ) : (
                            <h1 className="text-xl md:text-3xl text-center text-Primary font-bold">
                                Explore the table below to see your added foods.
                    ...
                    <section className="max-w-screen-xl mx-auto px-1 md:px-2">
                        <table className="border border-collapse  mx-auto">
                            <thead>
                                <tr>
                                    <th className="border text-xs md:text-lg text-Primary border-gray-400 py-2 md:p-2 w-1/4">
                                        Name
                                    </th>
                                    <th className="border text-xs md:text-lg text-Primary border-gray-400 py-2 md:p-2 w-1/4">
                                        Status
                            ...
                            <tbody>
                                {myFood.map((food, index) => (
                                    ...
                                    >
                                        <td className="border text-xs md:text-base border-gray-400 py-2 md:p-2 w-1/4 text-center">
                                            {food.name}
                                        </td>
                                        <td
                                            className={`border border-gray-400 md:p-2 w-1/4 text-xs py-2 md:text-base text-center ${
                                        ...
                                        <td className="border text-Secondary border-gray-400 py-2 md:p-2 w-1/4 ">
                                            <AiOutlineFileAdd
                                                onClick={() =>
                                                    handleManage(food._id)
                                                }
                                                className="text-xl mx-auto hover:cursor-pointer"
                                            ></AiOutlineFileAdd>
                                        </td>
                                        <td className="border border-gray-400 py-2 md:p-2 w-1/4">
                                            <AiFillEdit
                                                ...
                                                className="text-Primary mx-auto text-lg md:text-xl hover:cursor-pointer"
                                            />
                                        </td>
                                        <td className="border border-gray-400 py-2 md:p-2 w-1/4">
                                            <AiFillDelete
                                                onClick={() =>
                                                    handleDelet(food._id)
                                                }
                                                className="text-orange-600 text-lg md:text-xl mx-auto hover:cursor-pointer"
                                            />
                                        </td>
                                    </tr>
                                ))}
