            ...
            <section className="max-w-md  mx-auto px-2 md:px-6  md:max-w-lg lg:max-w-xl bg-white rounded-lg py-10 md:py-12">
                ...
                <form action="" onSubmit={handleUpdate}>
                    ...
                    <div>
                        ...
                        <TextInput name='name' id="input-gray" defaultValue={name} type='text' required color="gray"/>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput name='image' id="input-gray" type='text' defaultValue={image} required color="gray"/>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput name='quantity' id="input-gray" type='number' defaultValue={quantity} required color="gray"/>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput name='expireDate' id="input-gray" type='date' defaultValue={expireDate} required color="gray"/>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput name='location' id="input-gray" type='text' defaultValue={location} required color="gray"/>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput name='notes' id="input-gray" type='text' defaultValue={notes} required color="gray"/>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput name='status' id="input-gray" type='text' defaultValue={status} required color="gray"/>
                    </div>
