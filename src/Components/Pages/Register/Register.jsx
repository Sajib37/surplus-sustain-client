...
const Register = () => {
    ...
    const handleRegister = (event) => {
        ...
        const confirmPassword = form.confirmPssword.value;
    ...
    return (
        <div className="bg-gray-200 md:bg-gray-100 py-8 md:py-12 px-2">
            <Helmet>
                <title>Surplus Sustain || Registraion</title>
            </Helmet>
            <section className="max-w-md  mx-auto px-2 md:px-4  md:max-w-lg lg:max-w-lg bg-white rounded-lg py-10 md:py-12">
                ...
                <form action="" onSubmit={handleRegister}>
                    ...
                    <div>
                        ...
                        <TextInput name='photo' id="input-gray" placeholder="Enter your photo url" type='text' color="gray"/>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput name='confirmPssword' id="input-gray" placeholder="Confirm your password" type='password' required color="gray"/>
                    </div>
                    <button name='submit' className='w-full h-full mt-2 text-white bg-[#0E7490] py-2 rounded-lg'>Login</button>
                </form>
